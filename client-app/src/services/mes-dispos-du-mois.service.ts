...
class MesDisposDuMoisService {
  async findOneByCodeMoisPlanningAndIdFamille (codeMoisPlanning: string): Promise<MesDisposDuMois> {
    return await httpService.get(`/api/mes-dispos-du-mois/${codeMoisPlanning}`)
  }
